    ...
    <body>
        <div class="regdiv">
            <form method="post" align="center" class="regform">
                ...
                <input type="text" name="midname" required value="<? if(isset($_POST['midname'])) echo $_POST['midname']; ?>"><br />
                ...
                <input type="password" name="pass" required value="<? if(isset($_POST['pass'])) echo $_POST['pass']; ?>"><br />
                <label>Повторите пароль</label><br />
                <input type="password" name="pass1" required value="<? if(isset($_POST['pass1'])) echo $_POST['pass1']; ?>"><br />
